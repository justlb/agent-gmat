...
import type { GmatMissionTemplateId, GmatChatMode } from './gmatMissionTemplates'
...
export type MissionRouteResult =
  ...
  | { draft: OrbitKeepingDraft; kind: 'mission'; message: string; template: GmatMissionTemplateId }

export async function routeMissionMessage(message: string, workspaceDir?: string | null, runPath?: string | null, draftId?: string, template?: GmatMissionTemplateId): Promise<MissionRouteResult> {
