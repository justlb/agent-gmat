...
export const RUN_ARTIFACTS = [
  ...
  { id: "gmat-chemical-report", tool: "gmat", category: "result", kind: "report", contentType: "text/plain; charset=utf-8", relativePath: "ReportFile1.txt" },
  { id: "gmat-chemical-timeseries", tool: "gmat", category: "result", kind: "timeseries", contentType: "application/json; charset=utf-8", relativePath: "chemical_hohmann_timeseries.json" },
...
export function artifactDefinitionForPath(relativePath: string): RunArtifactDefinition | null {
  ...
  const rootArtifacts: Array<[RegExp, string, string]> = [
    ...
    [/^(?:orbit|electric_transfer|chemical_hohmann)_timeseries\.json$/u, "timeseries", "application/json; charset=utf-8"],
    ...
    [/^(?:ReboostReport|OrbitAnalysisReport|ElectricTransferReport|ReportFile1)\.txt$/u, "report", "text/plain; charset=utf-8"],
